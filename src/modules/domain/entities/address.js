...
export class Address {
  constructor({ customerId, id, street, neighborhood, city, state, postalCode, complement, createdAt }) {
  ...
  static create({ customerId, id, street, neighborhood, city, state, postalCode, complement, createdAt }) {
    ...
    return new Address({ customerId, id, street, neighborhood, city, state, postalCode, complement, createdAt });
  }
}
